...
public class NoTimeFixCoremod implements IFMLLoadingPlugin {
	...
	@Override
	public String getModContainerClass() { return "net.technicpack.notimefix.NoTimeFix"; }
	...
	@Override
	public String getAccessTransformerClass() { return "net.technicpack.notimefix.coremod.NoTimeFixAccessTransformer"; }
}
